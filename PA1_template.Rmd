...
The time interval with the max average steps was `r  summary[which.max(summary$avg),]$time` with an average of `r round(summary[which.max(summary$avg),]$avg, 2)` steps.  
